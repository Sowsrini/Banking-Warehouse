...
<div id="layoutSidenav" style="margin-top: 84px;">
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div id="layoutSidenav_nav"> <a href="gotoDashboard">Customer Info</a> <a href="gotoTransactionInfo"  class="active">Transaction Info</a><a href="gotoBranchInfo">Branch Info</a></div>
                </div>
	  ...
	  <form class="searchForm" action="findTransactionInfo">
                <h3>Enter Month</h3>
                <div class="searchBar">
            ...
            ${size}
											...
											<tr>
											<td> ${transactioninfo.customerId}</td>
											<td> ${transactioninfo.month} </td>
