...
<div id="layoutSidenav" style="margin-top: 84px;">
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div id="layoutSidenav_nav"> <a href="gotoDashboard" class="active">Customer Info</a> <a href="gotoTransactionInfo" >Transaction Info</a><a href="gotoBranchInfo">Branch Info</a></div>
                </div>
	  ...
	  <form class="searchForm" action="findcustomer">
                <h3>Search Customer Info:</h3>
                <div class="searchBar">
